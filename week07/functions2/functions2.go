...
// 구간(a~b) 소수 판정 프로그램 v1.4, isPrime 함수 안의 변수를 하나 줄이고 return 구문 추가, break 제거
func main() {
	var a, b int
